...
public class DashboardTest extends BaseTest {
    ...
    /**
        ...
        public void liveWidgetTest () throws InterruptedException, IOException {
            ...
            new MainPage(driver).checkEventItemsInBranch(cons.LIVE_WIDGET, cons.LIVE_EVENT, new MainPage(driver).eventRowLiveItems())
        ...
        public void soonStartWidget () throws IOException, InterruptedException {
            ...
            new MainPage(driver).scrollToWidget(cons.NEAR_FUTURE_WİDGET)
                    ...
                    .checkEventItemsInBranch(cons.NEAR_FUTURE_WİDGET, cons.EVENT_ROW, new MainPage(driver).eventRowItems());
