...
import com.tuttur.tutturWeb.web.page.DbQueriesPage;
...
public class LoginTest extends BaseTest {
    ...
    public void successfullyLoginWithAccountNo(String username, String password) throws IOException, InterruptedException {
    ...
    @Test()
    @Parameters({"username","password"})
    public void successfullyLoginWithUsername(String username, String password) throws IOException, InterruptedException {
